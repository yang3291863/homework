<template>
  <div class="app">
    <!-- 头部 -->
    <div class="header">
      <span class="header_left"><i class="el-icon-school" /> 教育部全国高校名单（截止2020-06-30）</span>
    ...
    <el-container class="container">
        ...
        <el-card v-model="flag">
          <el-menu :default-openeds="['1']" class="container_left_menu">
            <el-submenu index="1">
              ...
              <el-menu-item-group v-for="(type_item, type_key) in school_type" :key="type_key" v-model="submenu.school_type" class="submenu">
                <el-menu-item :index="'1-' + type_key.toString()" @click="getdata(type_item.key)">{{ type_item.value }}</el-menu-item>
              </el-menu-item-group>
            </el-submenu>
            ...
            <el-submenu index="2">
              ...
              <el-menu-item-group v-for="(province_item, province_key) in school_province" :key="province_key" v-model="submenu.school_province" class="submenu">
                <el-menu-item :index="'2-' + province_key.toString()" @click="seacherPlace(province_item.value)">{{ province_item.value }}</el-menu-item>
              </el-menu-item-group>
            </el-submenu>
          </el-menu>
        </el-card>
      ...
      <el-card class="container_right">
        <el-header><span class="dot">●</span><span style="float:left">{{ activeType }}</span></el-header>
        <el-main>
...
export default {
  data() {
    return {
      ...
      temp: {
        is_firstuniversity: '1',
        is_firstdiscipline: '0',
        is_985: '0',
        is_211: '0'
      },
      submenu: {
  ...
  methods: {
    seacherPlace(key) {
      ...
      axios.get('http://127.0.0.1:8083/school' + '?school_zone=' + key).then(response => {
